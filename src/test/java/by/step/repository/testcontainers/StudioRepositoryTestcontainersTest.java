...
@ActiveProfiles("test")
class StudioRepositoryTestcontainersTest extends PostgresTestcontainersBase {
    ...
    @Test
    void checkSearchByDescription() {
        List<Studio> studios = studioRepository.searchByDescription("профессиональных");
        Assertions.assertThat(studios).isNotEmpty();
        Assertions.assertThat(studios)
                .extracting(Studio::getName)
                .contains("Art Masters");
